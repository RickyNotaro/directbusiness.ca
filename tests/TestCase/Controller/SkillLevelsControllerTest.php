 ...
 */
class SkillLevelsControllerTest extends IntegrationTestCase
{
    ...
    {
        $SkillLevels = TableRegistry::get("SkillLevels");
        $entity = $SkillLevels->find("all")->first();
        $this->get("/Skill-Levels/view/" . $entity->id);
        $this->assertResponseOk();
    }
    ...
    public function testDelete()
    {
    	$SkillLevels = TableRegistry::get("SkillLevels");
    	$entity = $SkillLevels->find("all")->first();
    	$this->get("/Skill-Levels/delete/" . $entity->id);
    	$this->assertResponseOk();
    }
}
