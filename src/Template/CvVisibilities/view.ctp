...
?>
<li><?= $this->Html->link(__('Edit Cv Visibility'), ['action' => 'edit', $cvVisibility->id]) ?> </li>
<li><?= $this->Form->postLink(__('Delete Cv Visibility'), ['action' => 'delete', $cvVisibility->id], ['confirm' => __('Are you sure you want to delete # {0}?', $cvVisibility->id)]) ?> </li>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?= h($cvVisibility->id) ?></h3>
    </div>
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        <tr>
            <td><?= __('VisibilityName') ?></td>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($cvVisibility->cvs)): ?>
        <table class="table table-striped">
            ...
            <tbody>
            <?php foreach ($cvVisibility->cvs as $cvs): ?>
                <tr>
                    <td><?= h($cvs->id) ?></td>
                    <td><?= h($cvs->cvName) ?></td>
