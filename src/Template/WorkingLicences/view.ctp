...
?>
<li><?= $this->Html->link(__('Edit Working Licence'), ['action' => 'edit', $workingLicence->id]) ?> </li>
<li><?= $this->Form->postLink(__('Delete Working Licence'), ['action' => 'delete', $workingLicence->id], ['confirm' => __('Are you sure you want to delete # {0}?', $workingLicence->id)]) ?> </li>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?= h($workingLicence->id) ?></h3>
    </div>
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        <tr>
            <td><?= __('WorkingLicence') ?></td>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($workingLicence->cvs)): ?>
        <table class="table table-striped">
            ...
            <tbody>
            <?php foreach ($workingLicence->cvs as $cvs): ?>
                <tr>
                    <td><?= h($cvs->id) ?></td>
                    <td><?= h($cvs->cvName) ?></td>
