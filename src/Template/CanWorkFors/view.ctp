...
?>
<li><?= $this->Html->link(__('Edit Can Work For'), ['action' => 'edit', $canWorkFor->id]) ?> </li>
<li><?= $this->Form->postLink(__('Delete Can Work For'), ['action' => 'delete', $canWorkFor->id], ['confirm' => __('Are you sure you want to delete # {0}?', $canWorkFor->id)]) ?> </li>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?= h($canWorkFor->id) ?></h3>
    </div>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($canWorkFor->cvs)): ?>
        <table class="table table-striped">
            ...
            <tbody>
            <?php foreach ($canWorkFor->cvs as $cvs): ?>
                <tr>
                    <td><?= h($cvs->id) ?></td>
                    <td><?= h($cvs->cvName) ?></td>
