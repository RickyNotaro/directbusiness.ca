...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?= h($educationLevel->id) ?></h3>
    </div>
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        <tr>
            <td><?= __('EducationLevel') ?></td>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($educationLevel->cvs)): ?>
        <table class="table table-striped">
            ...
            <tbody>
            <?php foreach ($educationLevel->cvs as $cvs): ?>
                <tr>
                    <td><?= h($cvs->id) ?></td>
                    <td><?= h($cvs->cvName) ?></td>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($educationLevel->jobs)): ?>
        <table class="table table-striped">
            <thead>
            <tr>
                <th><?= __('Id') ?></th>
            ...
            <tbody>
            <?php foreach ($educationLevel->jobs as $jobs): ?>
                <tr>
                    <td><?= h($jobs->id) ?></td>
                    <td><?= h($jobs->title) ?></td>
