...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?= h($profession->id) ?></h3>
    </div>
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        <tr>
            <td><?= __('ProfessionName') ?></td>
            <td><?= h($profession->professionName) ?></td>
        </tr>
        <tr>
            <td><?= __('Id') ?></td>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($profession->cvs)): ?>
        <table class="table table-striped">
            ...
            <tbody>
            <?php foreach ($profession->cvs as $cvs): ?>
                <tr>
                    <td><?= h($cvs->id) ?></td>
                    <td><?= h($cvs->cvName) ?></td>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($profession->jobs)): ?>
        <table class="table table-striped">
            ...
            <tbody>
            <?php foreach ($profession->jobs as $jobs): ?>
                <tr>
                    <td><?= h($jobs->id) ?></td>
                    <td><?= h($jobs->title) ?></td>
