...
?>
<li><?= $this->Html->link(__('Edit Skill Card'), ['action' => 'edit', $skillCard->id]) ?> </li>
<li><?= $this->Form->postLink(__('Delete Skill Card'), ['action' => 'delete', $skillCard->id], ['confirm' => __('Are you sure you want to delete # {0}?', $skillCard->id)]) ?> </li>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?= h($skillCard->id) ?></h3>
    </div>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($skillCard->cvs)): ?>
        <table class="table table-striped">
            ...
            <tbody>
            <?php foreach ($skillCard->cvs as $cvs): ?>
                <tr>
                    <td><?= h($cvs->id) ?></td>
                    <td><?= h($cvs->cvName) ?></td>
